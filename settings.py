...
shuffle_wallets = False                 # Перемешивание кошельков

number_of_threads = 1                  # Количество потоков

time_delay_min = 30                    # Максимальная и
time_delay_max = 55                    # Минимальная задержка между ТРАНЗАКЦИЯМИ

TIME_DELAY_MIN = 5                     # Минимальное и
TIME_DELAY_MAX = 10                    # Максимальное время задержки между ПОТОКАМИ

TIME_DELAY_ACC_MIN = 10              # Минимальная и
TIME_DELAY_ACC_MAX = 20              # Максимальная задержка между АККАУНТАМИ
...
prescale_swap_max = 0.003                   # Максимальный множитель свапа баланса -> Будет среднее (Берется вся сумма вашего баланса и умножается на данный множитель
...
total_number_of_repetitions_min = 9        # Минимальное и
total_number_of_repetitions_max = 25        # Максимальное количество повторений (Кругов) (Всех свапалок)

number_of_repetitions_min = 1              # Минимальное и
number_of_repetitions_max = 2              # Максимальное количество повторений для одной свапалки (Если включено несколько свапалок то
...
liquidity_prescale_max = 0.003            # Максимальное значение в токенах ETH -> Будет рандомное среднее
...
number_nft_max = 2                          # Максимальное количество нфт для минта
